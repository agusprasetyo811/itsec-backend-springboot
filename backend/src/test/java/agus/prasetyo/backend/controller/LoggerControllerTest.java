...
public class LoggerControllerTest {
    ...
    public void testListOK() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/logs?sortBy=createdAt&sortDirection=asc")
    ...
    @Test
    public void testDeleteAllOk() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/logs/delete_all")
                        .contentType(MediaType.APPLICATION_JSON)
                .header("Authorization", "Bearer eyJhbGciOiJIUzI1NiJ9.eyJSb2xlcyI6IlJPTEVfQUxMIiwic3ViIjoidXNlcjEiLCJpYXQiOjE3Mzc3MTg0ODksImV4cCI6MTczNzc1NDQ4OX0.bg7YK0XAehegUW4XwyMjIm9YfqdMmoU2v9GH4jI1SAk"))
                .andExpect(status().isOk());
    }
    ...
    @Test
    public void testDeleteAllFailed() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/logs/delete_all")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().is(401));
    }
